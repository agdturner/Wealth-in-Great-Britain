...
protected static Double VESTV1;
...
protected static Double VESVB1;
...
protected static Double W4XSHHWGT;
...
YEAR = new Double(split[6]);
}
if (!split[7].trim().isEmpty()) {
MONTH = new Double(split[7]);
}
if (!split[8].trim().isEmpty()) {
HOUT = new Double(split[8]);
}
if (!split[9].trim().isEmpty()) {
W4XSHHWGT = new Double(split[9]);
}
if (!split[10].trim().isEmpty()) {
ACCOM = new Double(split[10]);
}
if (!split[11].trim().isEmpty()) {
FLTTYP = new Double(split[11]);
}
if (!split[12].trim().isEmpty()) {
ACCOTH = new Double(split[12]);
}
if (!split[13].trim().isEmpty()) {
TEN1 = new Double(split[13]);
}
if (!split[14].trim().isEmpty()) {
TIED = new Double(split[14]);
}
if (!split[15].trim().isEmpty()) {
LLORD = new Double(split[15]);
}
if (!split[16].trim().isEmpty()) {
FURN = new Double(split[16]);
}
if (!split[17].trim().isEmpty()) {
DVPRIRNT = new Double(split[17]);
}
if (!split[18].trim().isEmpty()) {
HHOWN = new Double(split[18]);
}
if (!split[19].trim().isEmpty()) {
HINTRO = new Double(split[19]);
}
if (!split[20].trim().isEmpty()) {
HAGEB = new Double(split[20]);
}
if (!split[21].trim().isEmpty()) {
HAGEYR = new Double(split[21]);
}
if (!split[22].trim().isEmpty()) {
HBUYYR = new Double(split[22]);
}
if (!split[23].trim().isEmpty()) {
HBUYSE = new Double(split[23]);
}
if (!split[24].trim().isEmpty()) {
HSHARE = new Double(split[24]);
}
if (!split[25].trim().isEmpty()) {
HSHAREP = new Double(split[25]);
}
if (!split[26].trim().isEmpty()) {
HPRICE = new Double(split[26]);
}
if (!split[27].trim().isEmpty()) {
HPRICEB = new Double(split[27]);
}
if (!split[28].trim().isEmpty()) {
HBFROM = new Double(split[28]);
}
if (!split[29].trim().isEmpty()) {
HRTBEV = new Double(split[29]);
}
if (!split[30].trim().isEmpty()) {
HHOSCH = new Double(split[30]);
}
if (!split[31].trim().isEmpty()) {
HVALUE = new Double(split[31]);
}
if (!split[32].trim().isEmpty()) {
HVALB = new Double(split[32]);
}
if (!split[33].trim().isEmpty()) {
HEXT1 = new Double(split[33]);
}
if (!split[34].trim().isEmpty()) {
HEXT2 = new Double(split[34]);
}
if (!split[35].trim().isEmpty()) {
HEXT3 = new Double(split[35]);
}
if (!split[36].trim().isEmpty()) {
HEXT4 = new Double(split[36]);
}
if (!split[37].trim().isEmpty()) {
MNUMBN = new Double(split[37]);
}
if (!split[38].trim().isEmpty()) {
MNUMB = new Double(split[38]);
}
if (!split[39].trim().isEmpty()) {
MW2CHK1 = new Double(split[39]);
}
if (!split[40].trim().isEmpty()) {
MW2CHK2 = new Double(split[40]);
}
if (!split[41].trim().isEmpty()) {
MW2CHK3 = new Double(split[41]);
}
if (!split[42].trim().isEmpty()) {
MEXTN = new Double(split[42]);
}
if (!split[43].trim().isEmpty()) {
MEXTRS1 = new Double(split[43]);
}
if (!split[44].trim().isEmpty()) {
MEXTRS2 = new Double(split[44]);
}
if (!split[45].trim().isEmpty()) {
MEXTRS3 = new Double(split[45]);
}
if (!split[46].trim().isEmpty()) {
MCHGE = new Double(split[46]);
}
if (!split[47].trim().isEmpty()) {
MCHGENUM = new Double(split[47]);
}
if (!split[48].trim().isEmpty()) {
MNUMBO = new Double(split[48]);
}
if (!split[49].trim().isEmpty()) {
MNAME1 = new Double(split[49]);
}
if (!split[50].trim().isEmpty()) {
MONAME1 = new Double(split[50]);
}
if (!split[51].trim().isEmpty()) {
MJNAME01 = new Double(split[51]);
}
if (!split[52].trim().isEmpty()) {
MJNAME02 = new Double(split[52]);
}
if (!split[53].trim().isEmpty()) {
MJNAME03 = new Double(split[53]);
}
if (!split[54].trim().isEmpty()) {
MJNAME04 = new Double(split[54]);
}
if (!split[55].trim().isEmpty()) {
MREAS01 = new Double(split[55]);
}
if (!split[56].trim().isEmpty()) {
MREAS02 = new Double(split[56]);
}
if (!split[57].trim().isEmpty()) {
MREAS03 = new Double(split[57]);
}
if (!split[58].trim().isEmpty()) {
MREAS04 = new Double(split[58]);
}
if (!split[59].trim().isEmpty()) {
MREAS05 = new Double(split[59]);
}
if (!split[60].trim().isEmpty()) {
MREAS06 = new Double(split[60]);
}
if (!split[61].trim().isEmpty()) {
MREAS07 = new Double(split[61]);
}
if (!split[62].trim().isEmpty()) {
MTYPE1 = new Double(split[62]);
}
if (!split[63].trim().isEmpty()) {
MENDW1 = new Double(split[63]);
}
if (!split[64].trim().isEmpty()) {
MENDNUM1 = new Double(split[64]);
}
if (!split[65].trim().isEmpty()) {
MALL1 = new Double(split[65]);
}
if (!split[66].trim().isEmpty()) {
MALLTY1 = new Double(split[66]);
}
if (!split[67].trim().isEmpty()) {
MVAL1 = new Double(split[67]);
}
if (!split[68].trim().isEmpty()) {
MVALB1 = new Double(split[68]);
}
if (!split[69].trim().isEmpty()) {
MNEG1 = new Double(split[69]);
}
if (!split[70].trim().isEmpty()) {
MNEGB1 = new Double(split[70]);
}
if (!split[71].trim().isEmpty()) {
MENDV1 = new Double(split[71]);
}
if (!split[72].trim().isEmpty()) {
MENDVB1 = new Double(split[72]);
}
if (!split[73].trim().isEmpty()) {
MENDY1 = new Double(split[73]);
}
if (!split[74].trim().isEmpty()) {
MENDV2 = new Double(split[74]);
}
if (!split[75].trim().isEmpty()) {
MENDVB2 = new Double(split[75]);
}
if (!split[76].trim().isEmpty()) {
MENDY2 = new Double(split[76]);
}
if (!split[77].trim().isEmpty()) {
MENDV3 = new Double(split[77]);
}
if (!split[78].trim().isEmpty()) {
MENDVB3 = new Double(split[78]);
}
if (!split[79].trim().isEmpty()) {
MENDY3 = new Double(split[79]);
}
if (!split[80].trim().isEmpty()) {
MENDV4 = new Double(split[80]);
}
if (!split[81].trim().isEmpty()) {
MENDVB4 = new Double(split[81]);
}
if (!split[82].trim().isEmpty()) {
MENDY4 = new Double(split[82]);
}
if (!split[83].trim().isEmpty()) {
MENDV5 = new Double(split[83]);
}
if (!split[84].trim().isEmpty()) {
MENDX1 = new Double(split[84]);
}
if (!split[85].trim().isEmpty()) {
MINVW1 = new Double(split[85]);
}
if (!split[86].trim().isEmpty()) {
MINVW2 = new Double(split[86]);
}
if (!split[87].trim().isEmpty()) {
MINVW3 = new Double(split[87]);
}
if (!split[88].trim().isEmpty()) {
MPOLICY1 = new Double(split[88]);
}
if (!split[89].trim().isEmpty()) {
MPOLICY2 = new Double(split[89]);
}
if (!split[90].trim().isEmpty()) {
MYLFT1 = new Double(split[90]);
}
if (!split[91].trim().isEmpty()) {
MYIFCH1 = new Double(split[91]);
}
if (!split[92].trim().isEmpty()) {
MPAYM1 = new Double(split[92]);
}
if (!split[93].trim().isEmpty()) {
MPAYB1 = new Double(split[93]);
}
if (!split[94].trim().isEmpty()) {
MINC1 = new Double(split[94]);
}
if (!split[95].trim().isEmpty()) {
MINC2 = new Double(split[95]);
}
if (!split[96].trim().isEmpty()) {
MINC3 = new Double(split[96]);
}
if (!split[97].trim().isEmpty()) {
MINC4 = new Double(split[97]);
}
if (!split[98].trim().isEmpty()) {
MINC5 = new Double(split[98]);
}
if (!split[99].trim().isEmpty()) {
MPP1 = new Double(split[99]);
}
if (!split[100].trim().isEmpty()) {
MHOWPY1 = new Double(split[100]);
}
if (!split[101].trim().isEmpty()) {
MARRS1 = new Double(split[101]);
}
if (!split[102].trim().isEmpty()) {
MARRSV1 = new Double(split[102]);
}
if (!split[103].trim().isEmpty()) {
MARR2YR1 = new Double(split[103]);
}
if (!split[104].trim().isEmpty()) {
MARR2YR2 = new Double(split[104]);
}
if (!split[105].trim().isEmpty()) {
MARR2YR3 = new Double(split[105]);
}
if (!split[106].trim().isEmpty()) {
MARRCL01 = new Double(split[106]);
}
if (!split[107].trim().isEmpty()) {
MARRCL02 = new Double(split[107]);
}
if (!split[108].trim().isEmpty()) {
MARRCL12 = new Double(split[108]);
}
if (!split[109].trim().isEmpty()) {
MNAME2 = new Double(split[109]);
}
if (!split[110].trim().isEmpty()) {
MONAME2 = new Double(split[110]);
}
if (!split[111].trim().isEmpty()) {
MJNAME18 = new Double(split[111]);
}
if (!split[112].trim().isEmpty()) {
MJNAME19 = new Double(split[112]);
}
if (!split[113].trim().isEmpty()) {
MJNAME20 = new Double(split[113]);
}
if (!split[114].trim().isEmpty()) {
MREAS12 = new Double(split[114]);
}
if (!split[115].trim().isEmpty()) {
MREAS13 = new Double(split[115]);
}
if (!split[116].trim().isEmpty()) {
MREAS14 = new Double(split[116]);
}
if (!split[117].trim().isEmpty()) {
MTYPE2 = new Double(split[117]);
}
if (!split[118].trim().isEmpty()) {
BRIDLN1 = new Double(split[118]);
}
if (!split[119].trim().isEmpty()) {
BRIDLN2 = new Double(split[119]);
}
if (!split[120].trim().isEmpty()) {
BRIDLN3 = new Double(split[120]);
}
if (!split[121].trim().isEmpty()) {
MENDW2 = new Double(split[121]);
}
if (!split[122].trim().isEmpty()) {
MENDNUM2 = new Double(split[122]);
}
if (!split[123].trim().isEmpty()) {
MALL2 = new Double(split[123]);
}
if (!split[124].trim().isEmpty()) {
MALLTY2 = new Double(split[124]);
}
if (!split[125].trim().isEmpty()) {
MVAL2 = new Double(split[125]);
}
if (!split[126].trim().isEmpty()) {
MVALB2 = new Double(split[126]);
}
if (!split[127].trim().isEmpty()) {
MNEG2 = new Double(split[127]);
}
if (!split[128].trim().isEmpty()) {
MNEGB2 = new Double(split[128]);
}
if (!split[129].trim().isEmpty()) {
MENDV6 = new Double(split[129]);
}
if (!split[130].trim().isEmpty()) {
MENDVB6 = new Double(split[130]);
}
if (!split[131].trim().isEmpty()) {
MENDY6 = new Double(split[131]);
}
if (!split[132].trim().isEmpty()) {
MENDV7 = new Double(split[132]);
}
if (!split[133].trim().isEmpty()) {
MENDVB7 = new Double(split[133]);
}
if (!split[134].trim().isEmpty()) {
MENDY7 = new Double(split[134]);
}
if (!split[135].trim().isEmpty()) {
MENDV8 = new Double(split[135]);
}
if (!split[136].trim().isEmpty()) {
MENDX2 = new Double(split[136]);
}
if (!split[137].trim().isEmpty()) {
MYLFT2 = new Double(split[137]);
}
if (!split[138].trim().isEmpty()) {
MYIFCH2 = new Double(split[138]);
}
if (!split[139].trim().isEmpty()) {
MPAYM2 = new Double(split[139]);
}
if (!split[140].trim().isEmpty()) {
MPAYB2 = new Double(split[140]);
}
if (!split[141].trim().isEmpty()) {
MINC6 = new Double(split[141]);
}
if (!split[142].trim().isEmpty()) {
MPP2 = new Double(split[142]);
}
if (!split[143].trim().isEmpty()) {
MHOWPY2 = new Double(split[143]);
}
if (!split[144].trim().isEmpty()) {
MARRS2 = new Double(split[144]);
}
if (!split[145].trim().isEmpty()) {
MARRSV2 = new Double(split[145]);
}
if (!split[146].trim().isEmpty()) {
MNAME3 = new Double(split[146]);
}
if (!split[147].trim().isEmpty()) {
MONAME3 = new Double(split[147]);
}
if (!split[148].trim().isEmpty()) {
MJNAME35 = new Double(split[148]);
}
if (!split[149].trim().isEmpty()) {
MJNAME36 = new Double(split[149]);
}
if (!split[150].trim().isEmpty()) {
MREAS23 = new Double(split[150]);
}
if (!split[151].trim().isEmpty()) {
MREAS24 = new Double(split[151]);
}
if (!split[152].trim().isEmpty()) {
MTYPE3 = new Double(split[152]);
}
if (!split[153].trim().isEmpty()) {
MENDW3 = new Double(split[153]);
}
if (!split[154].trim().isEmpty()) {
MENDNUM3 = new Double(split[154]);
}
if (!split[155].trim().isEmpty()) {
MALL3 = new Double(split[155]);
}
if (!split[156].trim().isEmpty()) {
MALLTY3 = new Double(split[156]);
}
if (!split[157].trim().isEmpty()) {
MVAL3 = new Double(split[157]);
}
if (!split[158].trim().isEmpty()) {
MVALB3 = new Double(split[158]);
}
if (!split[159].trim().isEmpty()) {
MNEG3 = new Double(split[159]);
}
if (!split[160].trim().isEmpty()) {
MNEGB3 = new Double(split[160]);
}
if (!split[161].trim().isEmpty()) {
MENDV11 = new Double(split[161]);
}
if (!split[162].trim().isEmpty()) {
MENDVB11 = new Double(split[162]);
}
if (!split[163].trim().isEmpty()) {
MENDY11 = new Double(split[163]);
}
if (!split[164].trim().isEmpty()) {
MENDX3 = new Double(split[164]);
}
if (!split[165].trim().isEmpty()) {
MYLFT3 = new Double(split[165]);
}
if (!split[166].trim().isEmpty()) {
MYIFCH3 = new Double(split[166]);
}
if (!split[167].trim().isEmpty()) {
MPAYM3 = new Double(split[167]);
}
if (!split[168].trim().isEmpty()) {
MPAYB3 = new Double(split[168]);
}
if (!split[169].trim().isEmpty()) {
MINC11 = new Double(split[169]);
}
if (!split[170].trim().isEmpty()) {
MPP3 = new Double(split[170]);
}
if (!split[171].trim().isEmpty()) {
MHOWPY3 = new Double(split[171]);
}
if (!split[172].trim().isEmpty()) {
MARRS3 = new Double(split[172]);
}
if (!split[173].trim().isEmpty()) {
MARRSV3 = new Double(split[173]);
}
if (!split[174].trim().isEmpty()) {
EQOLD = new Double(split[174]);
}
if (!split[175].trim().isEmpty()) {
EQNEW = new Double(split[175]);
}
if (!split[176].trim().isEmpty()) {
EQYES = new Double(split[176]);
}
if (!split[177].trim().isEmpty()) {
EQTYPE1 = new Double(split[177]);
}
if (!split[178].trim().isEmpty()) {
EQTYPE2 = new Double(split[178]);
}
if (!split[179].trim().isEmpty()) {
EQREAS1 = new Double(split[179]);
}
if (!split[180].trim().isEmpty()) {
EQREAS2 = new Double(split[180]);
}
if (!split[181].trim().isEmpty()) {
EQREAS3 = new Double(split[181]);
}
if (!split[182].trim().isEmpty()) {
EQREAS4 = new Double(split[182]);
}
if (!split[183].trim().isEmpty()) {
EQWHENY = new Double(split[183]);
}
if (!split[184].trim().isEmpty()) {
EQWHENM = new Double(split[184]);
}
if (!split[185].trim().isEmpty()) {
EQDRAW = new Double(split[185]);
}
if (!split[186].trim().isEmpty()) {
EQVAL = new Double(split[186]);
}
if (!split[187].trim().isEmpty()) {
EQVALB = new Double(split[187]);
}
if (!split[188].trim().isEmpty()) {
EQVALDR = new Double(split[188]);
}
if (!split[189].trim().isEmpty()) {
EQVALDRB = new Double(split[189]);
}
if (!split[190].trim().isEmpty()) {
EREC = new Double(split[190]);
}
if (!split[191].trim().isEmpty()) {
ERECMPD = new Double(split[191]);
}
if (!split[192].trim().isEmpty()) {
ERECMBY = new Double(split[192]);
}
if (!split[193].trim().isEmpty()) {
ERECTAX = new Double(split[193]);
}
if (!split[194].trim().isEmpty()) {
EINT = new Double(split[194]);
}
if (!split[195].trim().isEmpty()) {
EINTFIX = new Double(split[195]);
}
if (!split[196].trim().isEmpty()) {
EINTRAT = new Double(split[196]);
}
if (!split[197].trim().isEmpty()) {
EMSPAY = new Double(split[197]);
}
if (!split[198].trim().isEmpty()) {
EMSARR = new Double(split[198]);
}
if (!split[199].trim().isEmpty()) {
FRREPFIX = new Double(split[199]);
}
if (!split[200].trim().isEmpty()) {
SHARAPP = new Double(split[200]);
}
if (!split[201].trim().isEmpty()) {
ESHARAPP = new Double(split[201]);
}
if (!split[202].trim().isEmpty()) {
ERVREG1 = new Double(split[202]);
}
if (!split[203].trim().isEmpty()) {
ERVREG2 = new Double(split[203]);
}
if (!split[204].trim().isEmpty()) {
ERVSUM = new Double(split[204]);
}
if (!split[205].trim().isEmpty()) {
ERVSUMB = new Double(split[205]);
}
if (!split[206].trim().isEmpty()) {
ERVRECPD = new Double(split[206]);
}
if (!split[207].trim().isEmpty()) {
ERVRECBY = new Double(split[207]);
}
if (!split[208].trim().isEmpty()) {
ERVTAX = new Double(split[208]);
}
if (!split[209].trim().isEmpty()) {
ERVRENT = new Double(split[209]);
}
if (!split[210].trim().isEmpty()) {
ERVPRP = new Double(split[210]);
}
if (!split[211].trim().isEmpty()) {
EPRVPAY = new Double(split[211]);
}
if (!split[212].trim().isEmpty()) {
EPRVAL = new Double(split[212]);
}
if (!split[213].trim().isEmpty()) {
EPRPER = new Double(split[213]);
}
if (!split[214].trim().isEmpty()) {
EOTHREG = new Double(split[214]);
}
if (!split[215].trim().isEmpty()) {
EOTHRVA = new Double(split[215]);
}
if (!split[216].trim().isEmpty()) {
EOTHRVB = new Double(split[216]);
}
if (!split[217].trim().isEmpty()) {
PRREPAY = new Double(split[217]);
}
if (!split[218].trim().isEmpty()) {
PRREPFIX = new Double(split[218]);
}
if (!split[219].trim().isEmpty()) {
PRREPPC = new Double(split[219]);
}
if (!split[220].trim().isEmpty()) {
GCOLLEC = new Double(split[220]);
}
if (!split[221].trim().isEmpty()) {
GCOLLV = new Double(split[221]);
}
if (!split[222].trim().isEmpty()) {
GCOLLVB = new Double(split[222]);
}
if (!split[223].trim().isEmpty()) {
GCONTVB = new Double(split[223]);
}
if (!split[224].trim().isEmpty()) {
VCARN = new Double(split[224]);
}
if (!split[225].trim().isEmpty()) {
VTYPE1 = new Double(split[225]);
}
if (!split[226].trim().isEmpty()) {
VESTV1 = new Double(split[226]);
}
if (!split[227].trim().isEmpty()) {
VESVB1 = new Double(split[227]);
}
if (!split[228].trim().isEmpty()) {
VTYPE2 = new Double(split[228]);
}
if (!split[229].trim().isEmpty()) {
VESTV2 = new Double(split[229]);
}
if (!split[230].trim().isEmpty()) {
VESVB2 = new Double(split[230]);
}
if (!split[231].trim().isEmpty()) {
VPERS = new Double(split[231]);
}
if (!split[232].trim().isEmpty()) {
VPERV = new Double(split[232]);
}
if (!split[233].trim().isEmpty()) {
VOTYP1 = new Double(split[233]);
}
if (!split[234].trim().isEmpty()) {
VOTYP2 = new Double(split[234]);
}
if (!split[235].trim().isEmpty()) {
VOTYP3 = new Double(split[235]);
}
if (!split[236].trim().isEmpty()) {
VOTYP4 = new Double(split[236]);
}
if (!split[237].trim().isEmpty()) {
VOTPN = new Double(split[237]);
}
if (!split[238].trim().isEmpty()) {
VOVAL = new Double(split[238]);
}
if (!split[239].trim().isEmpty()) {
VOVLB = new Double(split[239]);
}
if (!split[240].trim().isEmpty()) {
MNUMB_I = new Double(split[240]);
}
if (!split[241].trim().isEmpty()) {
MNUMB_IFLAG = new Double(split[241]);
}
if (!split[242].trim().isEmpty()) {
MALL1_I = new Double(split[242]);
}
if (!split[243].trim().isEmpty()) {
MALL1_IFLAG = new Double(split[243]);
}
if (!split[244].trim().isEmpty()) {
MALL2_I = new Double(split[244]);
}
if (!split[245].trim().isEmpty()) {
MALL2_IFLAG = new Double(split[245]);
}
if (!split[246].trim().isEmpty()) {
MALL3_I = new Double(split[246]);
}
if (!split[247].trim().isEmpty()) {
MALL3_IFLAG = new Double(split[247]);
}
if (!split[248].trim().isEmpty()) {
MALLTY1_I = new Double(split[248]);
}
if (!split[249].trim().isEmpty()) {
MALLTY1_IFLAG = new Double(split[249]);
}
if (!split[250].trim().isEmpty()) {
MALLTY2_I = new Double(split[250]);
}
if (!split[251].trim().isEmpty()) {
MALLTY2_IFLAG = new Double(split[251]);
}
if (!split[252].trim().isEmpty()) {
MVAL1_I = new Double(split[252]);
}
if (!split[253].trim().isEmpty()) {
MVAL1_IFLAG = new Double(split[253]);
}
if (!split[254].trim().isEmpty()) {
MVAL2_I = new Double(split[254]);
}
if (!split[255].trim().isEmpty()) {
MVAL2_IFLAG = new Double(split[255]);
}
if (!split[256].trim().isEmpty()) {
MVAL3_I = new Double(split[256]);
}
if (!split[257].trim().isEmpty()) {
MVAL3_IFLAG = new Double(split[257]);
}
if (!split[258].trim().isEmpty()) {
MNEG1_I = new Double(split[258]);
}
if (!split[259].trim().isEmpty()) {
MNEG1_IFLAG = new Double(split[259]);
}
if (!split[260].trim().isEmpty()) {
MNEG2_I = new Double(split[260]);
}
if (!split[261].trim().isEmpty()) {
MNEG2_IFLAG = new Double(split[261]);
}
if (!split[262].trim().isEmpty()) {
TEN1_I = new Double(split[262]);
}
if (!split[263].trim().isEmpty()) {
TEN1_IFLAG = new Double(split[263]);
}
if (!split[264].trim().isEmpty()) {
HSHARE_I = new Double(split[264]);
}
if (!split[265].trim().isEmpty()) {
HSHARE_IFLAG = new Double(split[265]);
}
if (!split[266].trim().isEmpty()) {
HSHAREP_I = new Double(split[266]);
}
if (!split[267].trim().isEmpty()) {
HSHAREP_IFLAG = new Double(split[267]);
}
if (!split[268].trim().isEmpty()) {
EQUITY_YN_I = new Double(split[268]);
}
if (!split[269].trim().isEmpty()) {
EQUITY_YN_IFLAG = new Double(split[269]);
}
if (!split[270].trim().isEmpty()) {
EQTYPE1_I = new Double(split[270]);
}
if (!split[271].trim().isEmpty()) {
EQTYPE1_IFLAG = new Double(split[271]);
}
if (!split[272].trim().isEmpty()) {
EQDRAW_I = new Double(split[272]);
}
if (!split[273].trim().isEmpty()) {
EQDRAW_IFLAG = new Double(split[273]);
}
if (!split[274].trim().isEmpty()) {
EQVALB_I = new Double(split[274]);
}
if (!split[275].trim().isEmpty()) {
EQVALB_IFLAG = new Double(split[275]);
}
if (!split[276].trim().isEmpty()) {
EQVAL_I = new Double(split[276]);
}
if (!split[277].trim().isEmpty()) {
EQVAL_IFLAG = new Double(split[277]);
}
if (!split[278].trim().isEmpty()) {
EINT_I = new Double(split[278]);
}
if (!split[279].trim().isEmpty()) {
EINT_IFLAG = new Double(split[279]);
}
if (!split[280].trim().isEmpty()) {
EINTRAT_I = new Double(split[280]);
}
if (!split[281].trim().isEmpty()) {
EINTRAT_IFLAG = new Double(split[281]);
}
if (!split[282].trim().isEmpty()) {
ERVPRP_I = new Double(split[282]);
}
if (!split[283].trim().isEmpty()) {
ERVPRP_IFLAG = new Double(split[283]);
}
if (!split[284].trim().isEmpty()) {
PRREPAY_I = new Double(split[284]);
}
if (!split[285].trim().isEmpty()) {
PRREPAY_IFLAG = new Double(split[285]);
}
if (!split[286].trim().isEmpty()) {
PRREPFIX_I = new Double(split[286]);
}
if (!split[287].trim().isEmpty()) {
PRREPFIX_IFLAG = new Double(split[287]);
}
if (!split[288].trim().isEmpty()) {
PRREPPC_I = new Double(split[288]);
}
if (!split[289].trim().isEmpty()) {
PRREPPC_IFLAG = new Double(split[289]);
}
if (!split[290].trim().isEmpty()) {
MTYPE1_I = new Double(split[290]);
}
if (!split[291].trim().isEmpty()) {
MTYPE1_IFLAG = new Double(split[291]);
}
if (!split[292].trim().isEmpty()) {
MTYPE2_I = new Double(split[292]);
}
if (!split[293].trim().isEmpty()) {
MTYPE2_IFLAG = new Double(split[293]);
}
if (!split[294].trim().isEmpty()) {
MTYPE3_I = new Double(split[294]);
}
if (!split[295].trim().isEmpty()) {
MTYPE3_IFLAG = new Double(split[295]);
}
if (!split[296].trim().isEmpty()) {
MENDW1_I = new Double(split[296]);
}
if (!split[297].trim().isEmpty()) {
MENDW1_IFLAG = new Double(split[297]);
}
if (!split[298].trim().isEmpty()) {
MENDW2_I = new Double(split[298]);
}
if (!split[299].trim().isEmpty()) {
MENDW2_IFLAG = new Double(split[299]);
}
if (!split[300].trim().isEmpty()) {
MENDW3_I = new Double(split[300]);
}
if (!split[301].trim().isEmpty()) {
MENDW3_IFLAG = new Double(split[301]);
}
if (!split[302].trim().isEmpty()) {
MENDNUM1_I = new Double(split[302]);
}
if (!split[303].trim().isEmpty()) {
MENDNUM1_IFLAG = new Double(split[303]);
}
if (!split[304].trim().isEmpty()) {
MENDNUM2_I = new Double(split[304]);
}
if (!split[305].trim().isEmpty()) {
MENDNUM2_IFLAG = new Double(split[305]);
}
if (!split[306].trim().isEmpty()) {
MENDNUM3_I = new Double(split[306]);
}
if (!split[307].trim().isEmpty()) {
MENDNUM3_IFLAG = new Double(split[307]);
}
if (!split[308].trim().isEmpty()) {
MENDVB1_I = new Double(split[308]);
}
if (!split[309].trim().isEmpty()) {
MENDVB1_IFLAG = new Double(split[309]);
}
if (!split[310].trim().isEmpty()) {
MENDVB2_I = new Double(split[310]);
}
if (!split[311].trim().isEmpty()) {
MENDVB2_IFLAG = new Double(split[311]);
}
if (!split[312].trim().isEmpty()) {
MENDVB3_I = new Double(split[312]);
}
if (!split[313].trim().isEmpty()) {
MENDVB3_IFLAG = new Double(split[313]);
}
if (!split[314].trim().isEmpty()) {
MENDVB4_I = new Double(split[314]);
}
if (!split[315].trim().isEmpty()) {
MENDVB4_IFLAG = new Double(split[315]);
}
if (!split[316].trim().isEmpty()) {
MENDVB5_I = new Double(split[316]);
}
if (!split[317].trim().isEmpty()) {
MENDVB5_IFLAG = new Double(split[317]);
}
if (!split[318].trim().isEmpty()) {
MENDVB9_I = new Double(split[318]);
}
if (!split[319].trim().isEmpty()) {
MENDVB9_IFLAG = new Double(split[319]);
}
if (!split[320].trim().isEmpty()) {
MENDVB6_I = new Double(split[320]);
}
if (!split[321].trim().isEmpty()) {
MENDVB6_IFLAG = new Double(split[321]);
}
if (!split[322].trim().isEmpty()) {
MENDVB7_I = new Double(split[322]);
}
if (!split[323].trim().isEmpty()) {
MENDVB7_IFLAG = new Double(split[323]);
}
if (!split[324].trim().isEmpty()) {
MENDVB8_I = new Double(split[324]);
}
if (!split[325].trim().isEmpty()) {
MENDVB8_IFLAG = new Double(split[325]);
}
if (!split[326].trim().isEmpty()) {
MENDVB11_I = new Double(split[326]);
}
if (!split[327].trim().isEmpty()) {
MENDVB11_IFLAG = new Double(split[327]);
}
if (!split[328].trim().isEmpty()) {
MENDV1_I = new Double(split[328]);
}
if (!split[329].trim().isEmpty()) {
MENDV1_IFLAG = new Double(split[329]);
}
if (!split[330].trim().isEmpty()) {
MENDV2_I = new Double(split[330]);
}
if (!split[331].trim().isEmpty()) {
MENDV2_IFLAG = new Double(split[331]);
}
if (!split[332].trim().isEmpty()) {
MENDV3_I = new Double(split[332]);
}
if (!split[333].trim().isEmpty()) {
MENDV3_IFLAG = new Double(split[333]);
}
if (!split[334].trim().isEmpty()) {
MENDV4_I = new Double(split[334]);
}
if (!split[335].trim().isEmpty()) {
MENDV4_IFLAG = new Double(split[335]);
}
if (!split[336].trim().isEmpty()) {
MENDV5_I = new Double(split[336]);
}
if (!split[337].trim().isEmpty()) {
MENDV5_IFLAG = new Double(split[337]);
}
if (!split[338].trim().isEmpty()) {
MENDV6_I = new Double(split[338]);
}
if (!split[339].trim().isEmpty()) {
MENDV6_IFLAG = new Double(split[339]);
}
if (!split[340].trim().isEmpty()) {
MENDV7_I = new Double(split[340]);
}
if (!split[341].trim().isEmpty()) {
MENDV7_IFLAG = new Double(split[341]);
}
if (!split[342].trim().isEmpty()) {
HVALUE_I = new Double(split[342]);
}
if (!split[343].trim().isEmpty()) {
HVALUE_IFLAG = new Double(split[343]);
}
if (!split[344].trim().isEmpty()) {
DVHVALUE = new Double(split[344]);
}
if (!split[345].trim().isEmpty()) {
TOTMVAL = new Double(split[345]);
}
if (!split[346].trim().isEmpty()) {
TOTMNEG = new Double(split[346]);
}
if (!split[347].trim().isEmpty()) {
TOTMORT = new Double(split[347]);
}
if (!split[348].trim().isEmpty()) {
DVEQRELVAL = new Double(split[348]);
}
if (!split[349].trim().isEmpty()) {
DVEQLTM = new Double(split[349]);
}
if (!split[350].trim().isEmpty()) {
DVHORP = new Double(split[350]);
}
if (!split[351].trim().isEmpty()) {
DVEQSRB = new Double(split[351]);
}
if (!split[352].trim().isEmpty()) {
DVEQPRUN = new Double(split[352]);
}
if (!split[353].trim().isEmpty()) {
HMORTG = new Double(split[353]);
}
if (!split[354].trim().isEmpty()) {
ALLENDW = new Double(split[354]);
}
if (!split[355].trim().isEmpty()) {
HSETYPE = new Double(split[355]);
}
if (!split[356].trim().isEmpty()) {
VCARN_I = new Double(split[356]);
}
if (!split[357].trim().isEmpty()) {
VCARN_IFLAG = new Double(split[357]);
}
if (!split[358].trim().isEmpty()) {
VESTV_I = new Double(split[358]);
}
if (!split[359].trim().isEmpty()) {
VESTV_IFLAG = new Double(split[359]);
}
...
VTYPE_I = new Double(split[362]);
}
if (!split[363].trim().isEmpty()) {
VTYPE_IFLAG = new Double(split[363]);
}
if (!split[364].trim().isEmpty()) {
VTYPE2_I = new Double(split[364]);
}
if (!split[365].trim().isEmpty()) {
VTYPE2_IFLAG = new Double(split[365]);
}
if (!split[366].trim().isEmpty()) {
VPERS_I = new Double(split[366]);
}
if (!split[367].trim().isEmpty()) {
VPERS_IFLAG = new Double(split[367]);
}
if (!split[368].trim().isEmpty()) {
VPERV_I = new Double(split[368]);
}
if (!split[369].trim().isEmpty()) {
VPERV_IFLAG = new Double(split[369]);
}
if (!split[370].trim().isEmpty()) {
VOTYP1_I = new Double(split[370]);
}
if (!split[371].trim().isEmpty()) {
VOTYP2_I = new Double(split[371]);
}
if (!split[372].trim().isEmpty()) {
VOTYP3_I = new Double(split[372]);
}
if (!split[373].trim().isEmpty()) {
VOTYP4_I = new Double(split[373]);
}
if (!split[374].trim().isEmpty()) {
VOTYP5_I = new Double(split[374]);
}
if (!split[375].trim().isEmpty()) {
VOVAL_I = new Double(split[375]);
}
if (!split[376].trim().isEmpty()) {
VOVAL_IFLAG = new Double(split[376]);
}
if (!split[377].trim().isEmpty()) {
GCOLLEC_I = new Double(split[377]);
}
if (!split[378].trim().isEmpty()) {
GCOLLEC_IFLAG = new Double(split[378]);
}
if (!split[379].trim().isEmpty()) {
GCOLLV_I = new Double(split[379]);
}
if (!split[380].trim().isEmpty()) {
GCOLLV_IFLAG = new Double(split[380]);
}
if (!split[381].trim().isEmpty()) {
GCONTVB_I = new Double(split[381]);
}
if (!split[382].trim().isEmpty()) {
GCONTVB_IFLAG = new Double(split[382]);
}
if (!split[383].trim().isEmpty()) {
DVHSEVAL_SUM = new Double(split[383]);
}
if (!split[384].trim().isEmpty()) {
DVBLTVAL_SUM = new Double(split[384]);
}
if (!split[385].trim().isEmpty()) {
DVBLDVAL_SUM = new Double(split[385]);
}
if (!split[386].trim().isEmpty()) {
DVLUKVAL_SUM = new Double(split[386]);
}
if (!split[387].trim().isEmpty()) {
DVLOSVAL_SUM = new Double(split[387]);
}
if (!split[388].trim().isEmpty()) {
DVOPRVAL_SUM = new Double(split[388]);
}
if (!split[389].trim().isEmpty()) {
DVHSEDEBT_SUM = new Double(split[389]);
}
if (!split[390].trim().isEmpty()) {
DVBLTDEBT_SUM = new Double(split[390]);
}
if (!split[391].trim().isEmpty()) {
DVBLDDEBT_SUM = new Double(split[391]);
}
if (!split[392].trim().isEmpty()) {
DVLUKDEBT_SUM = new Double(split[392]);
}
if (!split[393].trim().isEmpty()) {
DVLOSDEBT_SUM = new Double(split[393]);
}
if (!split[394].trim().isEmpty()) {
DVOPRDEBT_SUM = new Double(split[394]);
}
if (!split[395].trim().isEmpty()) {
OTHMORT_SUM = new Double(split[395]);
}
if (!split[396].trim().isEmpty()) {
HOUSGDST_SUM = new Double(split[396]);
}
if (!split[397].trim().isEmpty()) {
BUYLGDST_SUM = new Double(split[397]);
}
if (!split[398].trim().isEmpty()) {
HOUSGDSOST_SUM = new Double(split[398]);
}
if (!split[399].trim().isEmpty()) {
PHYSHOUSGDST_AGGR = new Double(split[399]);
}
if (!split[400].trim().isEmpty()) {
PHYSBUYLGDST_AGGR = new Double(split[400]);
}
if (!split[401].trim().isEmpty()) {
PHYSHOUSGDSOST_AGGR = new Double(split[401]);
}
if (!split[402].trim().isEmpty()) {
GCONTVLS = new Double(split[402]);
}
if (!split[403].trim().isEmpty()) {
DVGCOLLV = new Double(split[403]);
}
if (!split[404].trim().isEmpty()) {
ALLGD = new Double(split[404]);
}
if (!split[405].trim().isEmpty()) {
DVTOTCARVAL = new Double(split[405]);
}
if (!split[406].trim().isEmpty()) {
DVTOTVANVAL = new Double(split[406]);
}
if (!split[407].trim().isEmpty()) {
DVTOTMOTBVAL = new Double(split[407]);
}
if (!split[408].trim().isEmpty()) {
DVTOTOTHVEHVAL = new Double(split[408]);
}
if (!split[409].trim().isEmpty()) {
DVTOTPERNPVAL = new Double(split[409]);
}
if (!split[410].trim().isEmpty()) {
DVTOTVEHVAL = new Double(split[410]);
}
if (!split[411].trim().isEmpty()) {
HPHYSW = new Double(split[411]);
}
if (!split[412].trim().isEmpty()) {
DVPROPERTY = new Double(split[412]);
}
if (!split[413].trim().isEmpty()) {
HPROPW = new Double(split[413]);
}
if (!split[414].trim().isEmpty()) {
DVCISAV_AGGR = new Double(split[414]);
}
if (!split[415].trim().isEmpty()) {
DVIISAV_AGGR = new Double(split[415]);
}
if (!split[416].trim().isEmpty()) {
DVKISAV_AGGR = new Double(split[416]);
}
if (!split[417].trim().isEmpty()) {
DVFNSVAL_AGGR = new Double(split[417]);
}
if (!split[418].trim().isEmpty()) {
DVFSHUKV_AGGR = new Double(split[418]);
}
if (!split[419].trim().isEmpty()) {
DVINSV_AGGR = new Double(split[419]);
}
if (!split[420].trim().isEmpty()) {
DVFLFENV_AGGR = new Double(split[420]);
}
if (!split[421].trim().isEmpty()) {
DVFLFSIV_AGGR = new Double(split[421]);
}
if (!split[422].trim().isEmpty()) {
DVFLFFSV_AGGR = new Double(split[422]);
}
if (!split[423].trim().isEmpty()) {
DVFLFTEV_AGGR = new Double(split[423]);
}
if (!split[424].trim().isEmpty()) {
DVFBONDV_AGGR = new Double(split[424]);
}
if (!split[425].trim().isEmpty()) {
DVFESHARES_AGGR = new Double(split[425]);
}
if (!split[426].trim().isEmpty()) {
DVFESHAV_AGGR = new Double(split[426]);
}
if (!split[427].trim().isEmpty()) {
DVFEOPTV_AGGR = new Double(split[427]);
}
if (!split[428].trim().isEmpty()) {
DVFCOLLV_AGGR = new Double(split[428]);
}
if (!split[429].trim().isEmpty()) {
DVFSHOSV_AGGR = new Double(split[429]);
}
if (!split[430].trim().isEmpty()) {
DVFGLTUKV_AGGR = new Double(split[430]);
}
if (!split[431].trim().isEmpty()) {
DVFGLTFOV_AGGR = new Double(split[431]);
}
if (!split[432].trim().isEmpty()) {
DVFINVOTV_AGGR = new Double(split[432]);
}
if (!split[433].trim().isEmpty()) {
DVFINFVAL_AGGR = new Double(split[433]);
}
if (!split[434].trim().isEmpty()) {
DVFINFLV_AGGR = new Double(split[434]);
}
if (!split[435].trim().isEmpty()) {
DVFINFV_AGGR = new Double(split[435]);
}
if (!split[436].trim().isEmpty()) {
DVISAVAL_AGGR = new Double(split[436]);
}
if (!split[437].trim().isEmpty()) {
DVFFASSETS_AGGR = new Double(split[437]);
}
if (!split[438].trim().isEmpty()) {
DVCACTV_AGGR = new Double(split[438]);
}
if (!split[439].trim().isEmpty()) {
DVCASVV_AGGR = new Double(split[439]);
}
if (!split[440].trim().isEmpty()) {
DVCAVAL_AGGR = new Double(split[440]);
}
if (!split[441].trim().isEmpty()) {
DVCACRVAL_AGGR = new Double(split[441]);
}
if (!split[442].trim().isEmpty()) {
DVCAODVAL_AGGR = new Double(split[442]);
}
if (!split[443].trim().isEmpty()) {
DVSAVAL_AGGR = new Double(split[443]);
}
if (!split[444].trim().isEmpty()) {
TOTCC_AGGR = new Double(split[444]);
}
if (!split[445].trim().isEmpty()) {
TOTSC_AGGR = new Double(split[445]);
}
if (!split[446].trim().isEmpty()) {
TOTMO_AGGR = new Double(split[446]);
}
if (!split[447].trim().isEmpty()) {
TOTNSLBNK_AGGR = new Double(split[447]);
}
if (!split[448].trim().isEmpty()) {
TOTNSLC_AGGR = new Double(split[448]);
}
if (!split[449].trim().isEmpty()) {
TOTOSLBNK_AGGR = new Double(split[449]);
}
if (!split[450].trim().isEmpty()) {
TOTOSLC_AGGR = new Double(split[450]);
}
if (!split[451].trim().isEmpty()) {
TOTSLBNK_AGGR = new Double(split[451]);
}
if (!split[452].trim().isEmpty()) {
TOTSLC_AGGR = new Double(split[452]);
}
if (!split[453].trim().isEmpty()) {
TOTBILLARR_AGGR = new Double(split[453]);
}
if (!split[454].trim().isEmpty()) {
TOTHPARR_AGGR = new Double(split[454]);
}
if (!split[455].trim().isEmpty()) {
TOTMOARR_AGGR = new Double(split[455]);
}
if (!split[456].trim().isEmpty()) {
TOTLNARR_AGGR = new Double(split[456]);
}
if (!split[457].trim().isEmpty()) {
TOTDVNWFLN_AGGR = new Double(split[457]);
}
if (!split[458].trim().isEmpty()) {
TOTDVNWILN_AGGR = new Double(split[458]);
}
if (!split[459].trim().isEmpty()) {
TOTARR_EXCMORT_AGGR = new Double(split[459]);
}
if (!split[460].trim().isEmpty()) {
HFINW_EXCENDW_AGGR = new Double(split[460]);
}
if (!split[461].trim().isEmpty()) {
HFINW_SUM = new Double(split[461]);
}
if (!split[462].trim().isEmpty()) {
DVVALDBT_AGGR = new Double(split[462]);
}
if (!split[463].trim().isEmpty()) {
DVVALDCOS_AGGR = new Double(split[463]);
}
if (!split[464].trim().isEmpty()) {
DVPAVCUV_AGGR = new Double(split[464]);
}
if (!split[465].trim().isEmpty()) {
DVPFDDV_AGGR = new Double(split[465]);
}
if (!split[466].trim().isEmpty()) {
DVPPVAL_AGGR = new Double(split[466]);
}
if (!split[467].trim().isEmpty()) {
TOTLOS_AGGR = new Double(split[467]);
}
if (!split[468].trim().isEmpty()) {
TOTNLOS_AGGR = new Double(split[468]);
}
if (!split[469].trim().isEmpty()) {
TOTFLNS_AGGR = new Double(split[469]);
}
if (!split[470].trim().isEmpty()) {
TOTHP_AGGR = new Double(split[470]);
}
if (!split[471].trim().isEmpty()) {
TOTLNS_AGGR = new Double(split[471]);
}
if (!split[472].trim().isEmpty()) {
HFINL_AGGR = new Double(split[472]);
}
if (!split[473].trim().isEmpty()) {
HFINWNT_SUM = new Double(split[473]);
}
if (!split[474].trim().isEmpty()) {
DVSPEN_AGGR = new Double(split[474]);
}
if (!split[475].trim().isEmpty()) {
DVPINPVAL_AGGR = new Double(split[475]);
}
if (!split[476].trim().isEmpty()) {
DVDBRWEALTHVAL_AGGR = new Double(split[476]);
}
if (!split[477].trim().isEmpty()) {
TOTPEN_AGGR = new Double(split[477]);
}
if (!split[478].trim().isEmpty()) {
TOTWLTH = new Double(split[478]);
}
if (!split[479].trim().isEmpty()) {
DVPFCURVAL_AGGR = new Double(split[479]);
}
if (!split[480].trim().isEmpty()) {
DVNIOTHI_AGGR = new Double(split[480]);
}
if (!split[481].trim().isEmpty()) {
HRPDVAGE = new Double(split[481]);
}
if (!split[482].trim().isEmpty()) {
HRPDVAGE9 = new Double(split[482]);
}
if (!split[483].trim().isEmpty()) {
HRPSEX = new Double(split[483]);
}
if (!split[484].trim().isEmpty()) {
HRPNSSEC3 = new Double(split[484]);
}
if (!split[485].trim().isEmpty()) {
HRPDVILO3A = new Double(split[485]);
}
if (!split[486].trim().isEmpty()) {
HRPDVMRDF = new Double(split[486]);
}
if (!split[487].trim().isEmpty()) {
HRPEDATTN1 = new Double(split[487]);
}
if (!split[488].trim().isEmpty()) {
HRPEDATTN2 = new Double(split[488]);
}
if (!split[489].trim().isEmpty()) {
HRPEDATTN3 = new Double(split[489]);
}
if (!split[490].trim().isEmpty()) {
HRPDVECACT = new Double(split[490]);
}
if (!split[491].trim().isEmpty()) {
HRPIOUT1 = new Double(split[491]);
}
if (!split[492].trim().isEmpty()) {
HRPPARTIOUT1 = new Double(split[492]);
}
if (!split[493].trim().isEmpty()) {
OFINAL = new Double(split[493]);
}
if (!split[494].trim().isEmpty()) {
NOUNITS = new Double(split[494]);
}
if (!split[495].trim().isEmpty()) {
DVHSIZE = new Double(split[495]);
}
if (!split[496].trim().isEmpty()) {
GOR = new Double(split[496]);
}
if (!split[497].trim().isEmpty()) {
NUMADULT = new Double(split[497]);
}
if (!split[498].trim().isEmpty()) {
NUMCH18 = new Double(split[498]);
}
if (!split[499].trim().isEmpty()) {
NUMCHILD = new Double(split[499]);
}
if (!split[500].trim().isEmpty()) {
NUMCIVPTR = new Double(split[500]);
}
if (!split[501].trim().isEmpty()) {
NUMCPART = new Double(split[501]);
}
if (!split[502].trim().isEmpty()) {
NUMDEPCH = new Double(split[502]);
}
if (!split[503].trim().isEmpty()) {
NUMELCH = new Double(split[503]);
}
if (!split[504].trim().isEmpty()) {
NUMHHLDR = new Double(split[504]);
}
if (!split[505].trim().isEmpty()) {
NUMMPART = new Double(split[505]);
}
if (!split[506].trim().isEmpty()) {
NUMNOELCH = new Double(split[506]);
}
if (!split[507].trim().isEmpty()) {
HHOLDTYPE = new Double(split[507]);
}
if (!split[508].trim().isEmpty()) {
HRPEDLEVEL = new Double(split[508]);
}
if (!split[509].trim().isEmpty()) {
VESVB3 = new Double(split[509]);
}
if (!split[510].trim().isEmpty()) {
HBEDRM = new Double(split[510]);
}
if (!split[511].trim().isEmpty()) {
CASEW4 = new Double(split[511]);
}
if (!split[512].trim().isEmpty()) {
CASEW3 = new Double(split[512]);
}
if (!split[513].trim().isEmpty()) {
CASEW2 = new Double(split[513]);
}
if (!split[514].trim().isEmpty()) {
CASEW1 = new Double(split[514]);
}
if (!split[515].trim().isEmpty()) {
DVTOTNIR = new Double(split[515]);
}
if (!split[516].trim().isEmpty()) {
DVTOTGIR = new Double(split[516]);
}
if (!split[517].trim().isEmpty()) {
DVGISE_AGGR = new Double(split[517]);
}
if (!split[518].trim().isEmpty()) {
DVGIPPEN_AGGR = new Double(split[518]);
}
if (!split[519].trim().isEmpty()) {
DVGIEMP_AGGR = new Double(split[519]);
}
if (!split[520].trim().isEmpty()) {
DVBENEFITANNUAL_AGGR = new Double(split[520]);
}
if (!split[521].trim().isEmpty()) {
DVGIINV_AGGR = new Double(split[521]);
}
if (!split[522].trim().isEmpty()) {
DVGRSRENTAMTANNUAL_AGGR = new Double(split[522]);
}
if (!split[523].trim().isEmpty()) {
DVNISE_AGGR = new Double(split[523]);
}
if (!split[524].trim().isEmpty()) {
DVNIPPEN_AGGR = new Double(split[524]);
}
if (!split[525].trim().isEmpty()) {
DVNIEMP_AGGR = new Double(split[525]);
}
if (!split[526].trim().isEmpty()) {
DVNIINV_AGGR = new Double(split[526]);
}
if (!split[527].trim().isEmpty()) {
DVNETRENTAMTANNUAL_AGGR = new Double(split[527]);
}
if (!split[528].trim().isEmpty()) {
DVOINRRANNUAL_AGGR = new Double(split[528]);
}
if (!split[529].trim().isEmpty()) {
DVOINGTANNUAL_AGGR = new Double(split[529]);
}
if (!split[530].trim().isEmpty()) {
DVOINEGANNUAL_AGGR = new Double(split[530]);
}
if (!split[531].trim().isEmpty()) {
DVOINFRANNUAL_AGGR = new Double(split[531]);
}
if (!split[532].trim().isEmpty()) {
DVOINMAANNUAL_AGGR = new Double(split[532]);
}
if (!split[533].trim().isEmpty()) {
DVOINROANNUAL_AGGR = new Double(split[533]);
}
if (!split[534].trim().isEmpty()) {
DVOINOPANNUAL_AGGR = new Double(split[534]);
}
if (!split[535].trim().isEmpty()) {
DVOIGRRANNUAL_AGGR = new Double(split[535]);
}
if (!split[536].trim().isEmpty()) {
DVOIGGTANNUAL_AGGR = new Double(split[536]);
}
if (!split[537].trim().isEmpty()) {
DVOIGEGANNUAL_AGGR = new Double(split[537]);
}
if (!split[538].trim().isEmpty()) {
DVOIGFRANNUAL_AGGR = new Double(split[538]);
}
if (!split[539].trim().isEmpty()) {
DVOIGMAANNUAL_AGGR = new Double(split[539]);
}
if (!split[540].trim().isEmpty()) {
DVOIGROANNUAL_AGGR = new Double(split[540]);
}
if (!split[541].trim().isEmpty()) {
DVOIGOPANNUAL_AGGR = new Double(split[541]);
}
if (!split[542].trim().isEmpty()) {
DVGIOTHR_AGGR = new Double(split[542]);
}
if (!split[543].trim().isEmpty()) {
DVNIOTHR_AGGR = new Double(split[543]);
}
if (!split[544].trim().isEmpty()) {
DVERECNETANNUAL = new Double(split[544]);
}
if (!split[545].trim().isEmpty()) {
DVERVRECNETANNUAL = new Double(split[545]);
}
if (!split[546].trim().isEmpty()) {
DVERECGROSSANNUAL = new Double(split[546]);
}
if (!split[547].trim().isEmpty()) {
DVERVRECGROSSANNUAL = new Double(split[547]);
}
}
}
