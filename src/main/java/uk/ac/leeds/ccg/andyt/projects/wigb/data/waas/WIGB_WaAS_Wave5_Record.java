 ...
 * @author geoagdt
 */
public class WIGB_WaAS_Wave5_Record extends WIGB_WaAS_Record {
    
    private WIGB_WaAS_Wave5_HHOLD_Record hhold;
    ...
    public WIGB_WaAS_Wave5_Record(WIGB_WaAS_Wave5_HHOLD_Record hhold,
            ArrayList<WIGB_WaAS_Wave5_PERSON_Record> people){
     ...
     * @return the hhold
     */
    public WIGB_WaAS_Wave5_HHOLD_Record getHhold() {
        return hhold;
    }
     ...
     * @return the people
     */
    public ArrayList<WIGB_WaAS_Wave5_PERSON_Record> getPeople() {
        return people;
    }
     ...
     */
    public void setHhold(WIGB_WaAS_Wave5_HHOLD_Record hhold) {
        this.hhold = hhold;
    }
}
