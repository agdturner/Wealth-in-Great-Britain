 ...
 * @author geoagdt
 */
public class WIGB_WaAS_HHOLD_ID implements Serializable {

    private byte wave;
    private short CASEID;
    private short CASEW1;

    public WIGB_WaAS_HHOLD_ID() {
    }

    public WIGB_WaAS_HHOLD_ID(byte wave, short CASEID, short CASEW1) {
        this.wave = wave;
        this.CASEID = CASEID;
        this.CASEW1 = CASEW1;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof WIGB_WaAS_HHOLD_ID) {
            WIGB_WaAS_HHOLD_ID o;
            o = (WIGB_WaAS_HHOLD_ID) obj;
