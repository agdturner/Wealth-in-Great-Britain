...
if (!s.trim().isEmpty()) {
SJEMP2_I = new Double(s);
}
}

protected final void initSJEMP2_IFLAG(String s) {
if (!s.trim().isEmpty()) {
SJEMP2_IFLAG = new Double(s);
}
}
