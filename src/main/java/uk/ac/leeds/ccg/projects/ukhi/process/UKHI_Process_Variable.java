...
/**
 * UKHI_Process_Variable
 * 
 * @author Andy Turner
 * @version 1.0.0
 */
public class UKHI_Process_Variable extends UKHI_Main_Process {

    public UKHI_Process_Variable(UKHI_Main_Process p) {
        super(p);
    }
     ...
     */
    public void createGraph(BigDecimal yIncrement, String vName) 
            throws FileNotFoundException, IOException, ClassNotFoundException {

        /**
         * Get Variable for each wave in the subsets.
         */
        TreeMap<Byte, Double> mSubset = (TreeMap<Byte, Double>) env.we.hh.getChangeVariableSubset(
...
//        changeSubset.put((byte) 12, 47155.80562571576);
         ...
         * records.
         */
        TreeMap<Byte, Double> changeAll = (TreeMap<Byte, Double>) env.we.hh.getChangeVariableAll(
...
//        changeAll.put((byte) 12, 38072.805181146614);
        ...
        env.env.log("GOR,GORName,change" + vName + "Subset,change" + vName + "All");
        ...
        // Graph data
        String title = "Average change in " + vName + " (Wave 5 minus Wave 1)";
        String xAxisLabel = "Government Office Region";
        String yAxisLabel = "£";
        int numberOfYAxisTicks = 10;
        createLineGraph(title, xAxisLabel, yAxisLabel, vName,
                mSubset, changeAll, numberOfYAxisTicks,
                yIncrement);
    }
}
